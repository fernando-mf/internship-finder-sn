...
return [
    ...
    */
    ...
    'min'                  => [
        ...
        'string' => 'Votre :attribute doit avoir au moins :min caractères.',
    ...
    // 'required'             => 'Veuillez entrer le :attribute.',
    ...
    */
    ...
    'custom' => [
        'email' => [
            ...
            'email' => 'Entrez une :attribute valide.',
        ],
        'password' => [
            'confirmed' => 'Les mots de passe doivent être identiques.'
        ],
        'co_ext' => [
            'integer' => 'Entrez une valeur valide',
        ],
        'co_phone' => [
            'min' => 'Entrez un téléphone valide.',
        ],
        'phone' => [
            'min' => 'Entrez un téléphone valide.',
        ]
