            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.store') }}">
                        ...
                        <div class="form-group{{ $errors->has('sudo') ? ' has-error' : '' }}">
                            <label for="sudo" class="col-md-4 control-label">Superadmin?</label>

                            <div class="col-md-6">
                                <select id="sudo" type="sudo" class="form-control" name="sudo">
